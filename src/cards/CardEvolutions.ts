...
export const EVOLUTION_UPGRADES: Record<string, Record<number, IUpgradeCard>> = {
    ...
    napalm: {
        2: {
            ...
            modifiers: {
                ...
                attackSpeedMultiplier: 1.1, // FASTER than base!
            },
            effects: [
    ...
    meteor: {
        3: {
            ...
            modifiers: {
                damage: 65, // MASSIVE
                attackSpeedMultiplier: 0.5, // VERY slow
            },
    ...
    frost: {
        2: {
            ...
            modifiers: {
                ...
                rangeMultiplier: 0.7, // Short range
            },
            effects: [{ type: 'slow', slowPower: 0.7, slowDuration: 6 }], // 70%!
    ...
    shatter: {
        2: {
            ...
            effects: [{ type: 'slow', slowPower: 0.25, slowDuration: 2, damageToSlowed: 1.6 }], // +60%!
    ...
    permafrost: {
        3: {
            ...
            effects: [{ type: 'slow', slowPower: 0.3, slowDuration: 2, damageToSlowed: 1.8 }], // +80%!
    ...
    glacier: {
        3: {
            ...
            modifiers: {
                damage: 18,
                rangeMultiplier: 1.1, // Extended range
            },
            effects: [
                { type: 'slow', slowPower: 0.35, slowDuration: 3, damageToSlowed: 1.5 },
    ...
    penetrator: {
        2: {
            ...
            effects: [{ type: 'pierce', pierceCount: 3, pierceDamageLoss: 0.1 }],
    ...
    executor: {
        3: {
            ...
            modifiers: {
                damage: 70, // MASSIVE
                range: 220,
                attackSpeedMultiplier: 0.2, // SNAIL
                critChance: 0.4, // 40% crit x3.0
            },
            effects: [],
    ...
    barrage: {
        2: {
            level: 2,
            modifiers: {
                damageMultiplier: 0.4, // Low per projectile
            },
    ...
    volley: {
        3: {
            ...
            modifiers: {
                ...
                attackSpeedMultiplier: 1.3, // FAST reload
            },
...
export const EVOLUTION_CHOICES: IEvolutionChoice[] = [
    ...
    },
    {
        ...
        pathB: {
            ...
            name: 'Выжигание',
            icon: '🔥',
            description: 'Быстрый стакающийся DoT',
            playstyle: 'STACK',
        },
    },
    ...
    },
    {
        ...
        pathA: {
            ...
            name: 'Рельсотрон',
            icon: '⚡',
            description: 'Pierce 6, дальность',
            playstyle: 'LASER',
        },
    ...
    },
    {
        ...
        pathB: {
            ...
            name: 'Подавитель',
            icon: '🛡️',
            description: 'Slow на макс разгоне',
            playstyle: 'CONTROL',
        },
    },
];
...
export function getEvolutionChoice(
    cardTypeId: string,
    sourceLevel: number,
    sourceEvolution?: string,
): IEvolutionChoice | null {
    const evo = sourceEvolution || 'classic';

    return (
        EVOLUTION_CHOICES.find(
            (choice) =>
...
export function getEvolutionDisplay(
    evolutionPath: string,
): { primary: string; secondary: string; color: string } | null {
